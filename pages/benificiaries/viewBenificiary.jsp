...
<article class="FormPage">
    <div class="container">
        ...
        <div class="content-wrapper formWrapper ">
            ...
            <html:form action="viewEditBenificiary">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                            <html:text property="benDesc" styleClass="form-control" styleId="benDesc" disabled="true"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                            <html:text property="benTotal" styleClass="form-control" styleId="benTotal" disabled="true"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <div class="offset-sm-2 col-sm-10">
                        <button type="button" onclick="javaScript:parent.location = '/viewEditBenificiary.do'"
