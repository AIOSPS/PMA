...
<article class="FormPage">
    <div class="container">
        ...
        <div class="content-wrapper formWrapper ">
            ...
            <html:form action="viewEditActivity">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                            <html:text property="actId" styleClass="form-control" styleId="actId" disabled="true"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="actDesc" class="col-sm-3 col-form-label">Description:</label>
                        <div class="col-sm-9">
                            <html:text property="actDesc" styleClass="form-control" styleId="actDesc" disabled="true"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                            <html:text property="actUnit" styleClass="form-control" styleId="actUnit" disabled="true"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="actUnitQty" class="col-sm-3 col-form-label">Unit Qty:</label>
                        <div class="col-sm-9">
                            <html:text property="actUnitQty" styleClass="form-control" styleId="actUnitQty" disabled="true"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                            <html:text property="actEstimatedBudget" styleClass="form-control" styleId="actEstimatedBudget" disabled="true"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <div class="offset-sm-2 col-sm-10">
                        <button type="button" onclick="javaScript:parent.location = '/viewEditActivity.do'"
