...
<article class="FormPage">
    <div class="container">
        ...
        <div class="content-wrapper formWrapper ">
            ...
            <html:form action="viewEditObjective">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                            <html:text property="objLongDesc" styleClass="form-control" styleId="objLongDesc" disabled="true"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="strDocId" class="col-sm-3 col-form-label">Strategic Plan Doc:</label>
                        <div class="col-sm-9">
                            <html:select property="strDocId" disabled="true"
                                         styleClass="selectpicker form-control">
                                <html:options collection="masterPlanList" property="strDocId" labelProperty="strDocId"/>
                            </html:select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class='input-group date col-sm-9' id='oDefineDate'>
                            <html:text property="objDefineDate" styleClass="form-control" styleId="objDefineDate" disabled="true"/>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class='input-group date col-sm-9' id='oCloseDate'>
                            <html:text property="objCloseDate" styleClass="form-control" styleId="objCloseDate" disabled="true"/>
                            <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                        </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                            <html:select property="objStatus" disabled="true"
                                         styleClass="selectpicker form-control">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                            <html:text property="ojbUserId" styleClass="form-control" styleId="ojbUserId" disabled="true"/>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
