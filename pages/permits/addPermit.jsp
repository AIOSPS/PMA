            ...
            <html:form action="addPermit">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class='input-group date col-sm-9' id='pSubmitDate'>
                            <html:text property="perSubmitDate" styleClass="form-control" styleId="perSubmitDate"/>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class='input-group date col-sm-9' id='pIssueDate'>
                            <html:text property="perIssueDate" styleClass="form-control" styleId="perIssueDate"/>
                            <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                        </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                            <html:text property="perPeriod" styleClass="form-control" styleId="perPeriod"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="perIssuingAgency" class="col-sm-3 col-form-label">Issuing Agency:</label>
                        <div class="col-sm-9">
                            <html:text property="perIssuingAgency" styleClass="form-control" styleId="perIssuingAgency"/>
                        </div>
                    </div>
                </div>
