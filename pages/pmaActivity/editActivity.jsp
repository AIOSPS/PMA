...
<div class="content-wrapper breadcrumb brd2 container">
    <div class="container clearfix">
        ...
        </a><span class=""> > </span><span>Add Activity</span></nav>
    </div>
</div>
            ...
            <html:form action="addPmaActivity">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <%--<div class="col-sm-9">--%>
                            <%--<html:text property="actvNo" styleClass="form-control" styleId="actvNo"/>--%>
                        <%--</div>--%>
                        <html:hidden property="actvNo"/>
                    </div>
                    <div class="col-md-6">
                                        ...
                                        <logic:present name="PmaActivityImplementerList">
                                            ...
                                            <tr id='addr<%=count%>' data-id="<%=count%>">
                                                <td data-name="actImplmnt">
                                                    ...
                                                    <select  class="form-control"  id="actImplmnt<%=count%>" name="actImplmnt<%=count%>">
                                                ...
                                                <td data-name="actCost">
                                                    <input type="text" id="actCost<%=count%>" name="actCost<%=count%>" value="<%=pmaActivityImplementer.getImplCost()%>" placeholder='Cost' class="form-control"/>
                                                </td>
                                                <td data-name="actCommunity">
                                                    ...
                                                    <select  class="form-control"  id="actCommunity<%=count%>" name="actCommunity<%=count%>">
                                    ...
                                    <table class="table table-bordered table-hover table-sortable" id="tab_logic2">
                                        ...
                                        <logic:present name="PmaActivityBeneficiaryList">
                                            ...
                                            <tr id='addr<%=count%>' data-id="<%=count%>">
                                                ...
                                                <td data-name="benTotal">
                                                    <input type="text" id="benTotal<%=count%>" name="benTotal<%=count%>" value="<%=pmaActivityBeneficiar.getBeneCount()%>" placeholder='Total' class="form-control"/>
                                                </td>
                                            </tr>
                                            <%
                                                    count++;
