...
<div class="content-wrapper breadcrumb brd2">
    <div class="container clearfix">
        ...
        </a><span class=""> > </span><span>View Result</span></nav>
    </div>
</div>
            ...
            <html:form action="addPmaResult">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                            ...
                            <div class="col-sm-9">
                            <html:text property="rsltNo" styleClass="form-control" styleId="rsltNo" disabled="true"/>
                            </div>
                    </div>
                    <div class="col-md-6">
                        <label for="rsltTitle" class="col-sm-3 col-form-label">Result Title:</label>
                        <div class="col-sm-9">
                            <html:text property="rsltTitle" styleClass="form-control" styleId="rsltTitle" disabled="true"/>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class='input-group date col-sm-9' id='rsltDefineDate'>
                            <html:text property="rsltDefineDate" styleClass="form-control" styleId="rsltDefineDate" disabled="true"/>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class='input-group date col-sm-9' id='rsltCloseDate'>
                            <html:text property="rsltCloseDate" styleClass="form-control" styleId="rsltCloseDate" disabled="true"/>
                            <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                        </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                            <html:text property="rsltLongDescription" styleClass="form-control" styleId="rsltLongDescription" disabled="true"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="col-sm-9">
                ...
                <div class="form-group row opBtn">
                    <div class="offset-sm-2 col-sm-10">
                        <button type="button" onclick="javaScript:parent.location = '/viewEditPmaResult.do?rsltNo=<%=request.getParameter("rsltNo")%>'"
