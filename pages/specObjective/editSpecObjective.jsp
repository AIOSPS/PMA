...
<div class="content-wrapper breadcrumb brd2">
    <div class="container clearfix">
        <nav class="menu-breadcrumb2"><a href="#" class="active"><span class="fa fa-home "></span> Specific Objective Information
        </a><span class=""> > </span><span>Specific Objectives</span></nav>
    </div>
</div>
            ...
            <html:form action="AddSpecObjective">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <%--</div>--%>
                            <html:hidden property="sobjNo"/>
                    </div>
                    <div class="col-md-6">
                        <label for="sobjDescription" class="col-sm-3 col-form-label">Description:</label>
                        <div class="col-sm-9">
                            <html:text property="sobjDescription" styleClass="form-control" styleId="sobjDescription"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class='input-group date col-sm-9' id='sobjDefineDate'>
                            <html:text property="sobjDefineDate" styleClass="form-control" styleId="sobjDefineDate"/>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class='input-group date col-sm-9' id='rCloseDate'>
                            <html:text property="sobjAdaptationDate" styleClass="form-control" styleId="sobjAdaptationDate"/>
                            <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                        </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                            <html:text property="sobjRelatedDocuments" styleClass="form-control" styleId="sobjRelatedDocuments"/>
                        </div>
                    </div>
                    <div class="col-md-6">
