 ...
 */
public class PmaProgramsViewPK implements Serializable {
    ...
    /** full constructor */
    public PmaProgramsViewPK(String actvNo, String intrNo) {
        this.actvNo = actvNo;
        this.intrNo = intrNo;
    }

    /** default constructor */
    public PmaProgramsViewPK() {
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof PmaProgramsViewPK) ) return false;
        PmaProgramsViewPK castOther = (PmaProgramsViewPK) other;
