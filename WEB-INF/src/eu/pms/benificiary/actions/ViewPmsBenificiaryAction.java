...
//            return mapping.findForward("noPermission");
        ...
        PmsProjectsBenificiary pmsBenificiary = null;
        if (benificiaryList != null && benificiaryList.size() > 0 && benificiaryList.get(0) instanceof PmsProjectsBenificiary) {
            pmsBenificiary = (PmsProjectsBenificiary) benificiaryList.get(0);
    ...
    private void fillPmsActivityData(PmsBenificiaryForm pmsBenificiaryForm, PmsProjectsBenificiary pmsBenificiary) {
        pmsBenificiaryForm.setProId(pmsBenificiary.getCompId().getProId());
        pmsBenificiaryForm.setBenTotal(pmsBenificiary.getBenTotal());
        pmsBenificiaryForm.setBtpId(pmsBenificiary.getCompId().getBtpId());
    }
}
